...
const Projects = () => {
  ...
  return (
    <div
      id="Project"
      className="bg-zinc-950 bg-gradient-to-r from-[#48c9af90] to-black via-[#48c9af32] via-25%  border-b-[#48c9af60] border-b w-[100%] overflow-hidden xl:py-24 py-[8vh] xl:h-[105vh]"
    >
      <h2 className="text-[#48C9B0] relative z-30 text-center 2xl:text-xl lg:text-3xl md:text-xl text-sm font-[400]">
        Explore
      </h2>
